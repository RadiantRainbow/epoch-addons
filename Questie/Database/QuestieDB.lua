            ...
            if o[5] then -- db ref
                ...
                if type(o[5]) == "table" then
                    for _, ref in pairs(o[5]) do
                        if ref and type(ref) == "table" and ref[1] and ref[2] then
                            local spawnListResult = _QuestieQuest.objectiveSpawnListCallTable[ref[1]]
                            if spawnListResult then
                                local spawnData = spawnListResult(ref[2], specialObjective)
