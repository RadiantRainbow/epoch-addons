...
### [Download Latest](https://github.com/gimikz/GroupBulletinBoard/releases/latest)

Added support for [Project Epoch](https://www.project-epoch.net/) custom dungeons; a future update will clean up non-relevant TBC dungeons and code.

Original work done by fondlez to port to WotLK (3.3.5a); credit to them for the work they put into this addon.
...
Download and unzip GroupBulletinBoard into your `..\Ascension Launcher\resources\epoch_live\Interface\Addons` directory

You can also use [GitAddonsManager](https://woblight.gitlab.io/overview/gitaddonsmanager/) to manage your GitHub addon(s)
